...
var RemoteDeviceManagementService = module.exports = function RemoteDeviceManagementService(options) {
  ...
  this._host = options.host || "iotrdmsiotservices-" + this._account;
  this._landscape = options.landscape || "trial.hanatrial.ondemand.com";
  this._path =  options.path || "/com.sap.iotservices.dms/api/";
